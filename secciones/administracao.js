...
// ---------- Dados da Administração ----------
  ...
  const equipa = [
    { id:"diretor-geral", nome:"Nome do Director-Geral", cargo:"Director-Geral", foto:"Imagens/fondo_fermas.png",
    ...
    { id:"subdiretor-pedagogico", nome:"Nome do Subdirector Pedagógico", cargo:"Subdirector Pedagógico", foto:"Imagens/Fermas_fondo2.png",
    ...
    { id:"diretor-pre-escolar", nome:"Nome do Director da Educação Pré-Escolar", cargo:"Director da Educação Pré-Escolar", foto:"Imagens/Fermas_fondo2.png",
      bio:["Biografia do Director da Educação Pré-Escolar. Substitua este texto pela formação e percurso profissional."] },
    { id:"diretor-primario", nome:"Nome do Director do Ensino Primário", cargo:"Director do Ensino Primário", foto:"Imagens/fondo_fermas.png",
      bio:["Biografia do Director do Ensino Primário. Substitua este texto pela formação e percurso profissional."] },
    { id:"diretor-iciclo", nome:"Nome do Director do I Ciclo", cargo:"Director do I Ciclo do Ensino Secundário", foto:"Imagens/Fermas_fondo2.png",
      bio:["Biografia do Director do I Ciclo. Substitua este texto pela formação e percurso profissional."] },
    { id:"diretor-iiciclo", nome:"Nome do Director do II Ciclo", cargo:"Director do II Ciclo do Ensino Secundário", foto:"Imagens/fondo_fermas.png",
      bio:["Biografia do Director do II Ciclo. Substitua este texto pela formação e percurso profissional."] },
    { id:"coordenador-pedagogico", nome:"Nome do Coordenador Pedagógico", cargo:"Coordenador Pedagógico", foto:"Imagens/Fermas_fondo2.png",
      bio:["Biografia do Coordenador Pedagógico. Substitua este texto pela formação e percurso profissional."] },
    { id:"coordenador-disciplina", nome:"Nome do Coordenador de Disciplina", cargo:"Coordenador de Disciplina", foto:"Imagens/fondo_fermas.png",
      bio:["Biografia do Coordenador de Disciplina. Substitua este texto pela formação e percurso profissional."] },
    { id:"chefe-secretaria", nome:"Nome do Chefe de Secretaria", cargo:"Chefe de Secretaria", foto:"Imagens/Fermas_fondo2.png",
      bio:["Biografia do Chefe de Secretaria. Substitua este texto pela formação e percurso profissional."] },
    { id:"recursos-humanos", nome:"Nome do Responsável de Recursos Humanos", cargo:"Responsável de Recursos Humanos", foto:"Imagens/fondo_fermas.png",
      bio:["Biografia do Responsável de Recursos Humanos. Substitua este texto pela formação e percurso profissional."] },
    { id:"instalacoes-logistica", nome:"Nome do Responsável de Instalações e Logística", cargo:"Responsável de Instalações e Logística", foto:"Imagens/Fermas_fondo2.png",
